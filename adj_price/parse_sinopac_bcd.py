...
SINOPAC_BCD_BASE_URL = "https://stockchannelnew.sinotrade.com.tw/z/BCD/czkc1.djbcd"
DEFAULT_REFERER = "https://stockchannelnew.sinotrade.com.tw/"
...
def build_sinopac_bcd_url(
    ...
    return f"{SINOPAC_BCD_BASE_URL}?{query}"


def fetch_sinopac_bcd_rows(
    stock_id: str,
    cookie: str | None = None,
    market: str = "A",
    compare_stock_id: str = "2880",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch and parse Sinopac DJ BCD payload.")
    parser.add_argument("stock_id", help="Target stock id, for example 2330.")
    parser.add_argument(
        "--cookie",
